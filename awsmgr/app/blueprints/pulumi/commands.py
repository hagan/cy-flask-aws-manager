...
def base_awscmd(
    ...
    pulumi_cmds = ['create-s3', 'destroy-s3', 'create-vpc', 'destroy-vpc', 'create-ec2', 'destroy-ec2']
    boto_cmds = ['start-ec2', 'stop-ec2']

    valid_cmds = pulumi_cmds + boto_cmds
    ...
    elif command in boto_cmds:
        boto_main_stack(command)
